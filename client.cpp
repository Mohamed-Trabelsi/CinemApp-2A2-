...
Client::Client(int i,QString n,QString p,QString a){
    id=i;
    nom=n;
    prenom=p;
    adresse=a;
...
QSqlQueryModel *Client::rechercher_id(QString txt)
  {
...
QSqlQueryModel *Client::rechercher_nom(QString txt)
  {
...
QSqlQueryModel *Client::rechercher_adresse(QString txt)
  {
